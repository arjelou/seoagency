    ...
    <div className="px-32 pt-[130px]">
        <div className="grid grid-cols-2 pt-7">
            ...
            <div className="justify-start items-start">
                ...
                <div className='pt-5'>
                    <h1 className="text-6xl font-medium">We always strive to</h1>
                    <h1 className="text-6xl font-medium">provide the <bold className="text-blue-600">best</bold> in</h1>
                    <h1 className="text-6xl font-medium">every service we offer</h1>
                    <p className="pt-5 text-[18px] font-medium">We have a history of delivering successful SEO campaigns for businesses across various industries. Our results-driven approach ensures that you achieve tangible outcomes and maximize your return on investment.</p>
                        <div className="pt-5">
                            <div className="pb-5">
